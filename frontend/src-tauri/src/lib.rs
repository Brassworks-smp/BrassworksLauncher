...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::set_instance_global_files,
            commands::sync_global_files,
            commands::open_global_files_folder,
            commands::reveal_global_files_config,
            ...
            commands::content_filter_options,
            ...
            commands::modpack_filter_options,
            ...
            commands::forge_token_present,
            commands::forge_remembered,
